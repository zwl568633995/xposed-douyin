...
import com.ehook.helper.ReflecterHelper.findMethodsByExactName
...
abstract class HookCenter : IHookProvider {
    ...
    private fun iMethodHooker(
        ...
        return EHook {
            if (clazz == null || method == null) return@EHook
...
//                        LogUtil.e(
//                            HookCenter::class.java.name,
//                            "afterHookedMethod: ${param.toString()}"
//                        )
