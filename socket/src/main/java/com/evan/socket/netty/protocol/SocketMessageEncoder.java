...
public class SocketMessageEncoder extends MessageToByteEncoder<SocketNatMessage> {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, SocketNatMessage msg, ByteBuf out) throws Exception {
