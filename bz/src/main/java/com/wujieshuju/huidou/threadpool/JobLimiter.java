...
import com.wujieshuju.huidou.util.Utils;
...
public class JobLimiter implements FutureListener {
    ...
    private static class JobWrapper<T> implements Future<T>, ThreadPool.Job<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0012, code lost:
            com.wujieshuju.huidou.util.LogUtil.m824w(com.wujieshuju.huidou.threadpool.JobLimiter.TAG, "error executing job: " + r0, r6);
            r6 = null;
         */
        ...
        public T run(com.wujieshuju.huidou.threadpool.ThreadPool.JobContext r6) {
            /*
                r5 = this;
                monitor-enter(r5)
                ...
                return r2
            L_0x0009:
                com.wujieshuju.huidou.threadpool.ThreadPool$Job<T> r0 = r5.mJob     // Catch:{ all -> 0x0048 }
                monitor-exit(r5)     // Catch:{ all -> 0x0048 }
            ...
            L_0x0011:
                ...
                com.wujieshuju.huidou.util.LogUtil.m824w(r3, r0, r6)
                r6 = r2
            L_0x0029:
                monitor-enter(r5)
            ...
            L_0x0030:
                ...
                com.wujieshuju.huidou.threadpool.FutureListener<T> r0 = r5.mListener     // Catch:{ all -> 0x0045 }
            ...
            L_0x0048:
                ...
                throw r6
            */
            throw new UnsupportedOperationException("Method not decompiled: com.wujieshuju.huidou.threadpool.JobLimiter.JobWrapper.run(com.wujieshuju.huidou.threadpool.ThreadPool$JobContext):java.lang.Object");
        }
    }
