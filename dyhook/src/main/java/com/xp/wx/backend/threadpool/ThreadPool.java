...
public class ThreadPool {
    ...
    public ThreadPool() {
        ...
        this.mExecutor = new ThreadPoolExecutor(8, 50, 10, TimeUnit.SECONDS, new LinkedBlockingQueue(), new PriorityThreadFactory("xp-thread-pool", 10));
    }

    public ThreadPool(int i) {
        this.mCpuCounter = new ResourceCounter(2);
        this.mNetworkCounter = new ResourceCounter(2);
        this.mExecutor = new ThreadPoolExecutor(i, 50, 10, TimeUnit.SECONDS, new LinkedBlockingQueue(), new PriorityThreadFactory("xp-thread-pool", 10));
    }
    ...
    private class Worker<T> implements Runnable, Future<T>, JobContext {
        ...
        public void run() {
            /*
                ...
                com.xp.wx.backend.threadpool.ThreadPool$Job<T> r1 = r4.mJob     // Catch:{ all -> 0x000e }
            ...
            L_0x0017:
                ...
                com.xp.wx.backend.threadpool.FutureListener<T> r0 = r4.mListener
            ...
            L_0x002c:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xp.wx.backend.threadpool.ThreadPool.Worker.run():void");
        }
        ...
        public synchronized void cancel() {
            ...
            L_0x0007:
                ...
                com.xp.wx.backend.threadpool.ThreadPool$ResourceCounter r0 = r2.mWaitOnResource     // Catch:{ all -> 0x0026 }
                if (r0 == 0) goto L_0x001b
                com.xp.wx.backend.threadpool.ThreadPool$ResourceCounter r0 = r2.mWaitOnResource     // Catch:{ all -> 0x0026 }
                monitor-enter(r0)     // Catch:{ all -> 0x0026 }
                com.xp.wx.backend.threadpool.ThreadPool$ResourceCounter r1 = r2.mWaitOnResource     // Catch:{ all -> 0x0018 }
            ...
            L_0x001b:
                com.xp.wx.backend.threadpool.ThreadPool$CancelListener r0 = r2.mCancelListener     // Catch:{ all -> 0x0026 }
            ...
            L_0x0026:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xp.wx.backend.threadpool.ThreadPool.Worker.cancel():void");
        }
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private boolean acquireResource(com.xp.wx.backend.threadpool.ThreadPool.ResourceCounter r4) {
            /*
                r3 = this;
            L_0x0000:
                monitor-enter(r3)
            ...
            L_0x002e:
                goto L_0x002d
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xp.wx.backend.threadpool.ThreadPool.Worker.acquireResource(com.xp.wx.backend.threadpool.ThreadPool$ResourceCounter):boolean");
        }
