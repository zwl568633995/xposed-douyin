...
public final class Methods$$special$$inlined$dyLazy$6 extends Lambda implements Function0<Method> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Methods$$special$$inlined$dyLazy$6(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method method = null;
            Method method2 = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassCommentWidget(), (Class<?>) null, C.INSTANCE.getString(), C.INSTANCE.getBoolean(), C.INSTANCE.getBoolean()));
            if (method2 != null) {
