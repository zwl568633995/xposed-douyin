...
public final class Classes$$special$$inlined$dyLazy$14 extends Lambda implements Function0<Class<? extends Object>> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Classes$$special$$inlined$dyLazy$14(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Class<? extends Object> invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            String str = Classes.INSTANCE.getChildPackage() + ".v";
