...
import com.xp.wx.spellbook.douyin.mirror.com.ss.android.ugc.aweme.im.sdk.chat.model.Classes;
...
public final class Methods$$special$$inlined$dyLazy$4 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassImSdkUtilsBh(), "b", C.INSTANCE.getString(), Classes.INSTANCE.getClassImSdkChatModelBaseContent(), Classes.INSTANCE.getClassImSdkUtilsBh_a());
