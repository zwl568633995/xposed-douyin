...
import com.xp.wx.spellbook.douyin.mirror.com.ss.android.ugc.aweme.profile.model.Classes;
...
public final class Methods$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method method = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassCommonFollowApi(), Classes.INSTANCE.getClassFollowStatus(), C.INSTANCE.getString(), C.INSTANCE.getString(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getString(), C.INSTANCE.getInt(), C.INSTANCE.getString()));
            if (method != null) {
                return method;
            }
