...
public final class Fields$$special$$inlined$dyLazy$24 extends Lambda implements Function0<Field> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Fields$$special$$inlined$dyLazy$24(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Field findFieldIfExists = ReflectionUtil.findFieldIfExists(Classes.INSTANCE.getClassProfileModelUser(), "signature");
