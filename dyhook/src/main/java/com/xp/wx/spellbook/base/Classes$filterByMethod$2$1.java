...
final class Classes$filterByMethod$2$1 extends Lambda implements Function1<Class<?>, String> {
    public static final Classes$filterByMethod$2$1 INSTANCE = new Classes$filterByMethod$2$1();

    Classes$filterByMethod$2$1() {
        super(1);
    }
