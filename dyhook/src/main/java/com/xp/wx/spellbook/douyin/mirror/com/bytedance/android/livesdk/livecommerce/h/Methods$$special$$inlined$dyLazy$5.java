...
public final class Methods$$special$$inlined$dyLazy$5 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassLivesdkLivecommerceHC(), "b", C.INSTANCE.getString(), C.INSTANCE.getList());
