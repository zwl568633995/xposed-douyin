...
public final class Methods$$special$$inlined$dyLazy$1 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassFollowRelationApi(), "queryFollowerList", C.INSTANCE.getString(), C.INSTANCE.getString(), C.INSTANCE.getLong(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getInt());
