...
public final class Methods$$special$$inlined$dyLazy$4 extends Lambda implements Function0<Method> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Methods$$special$$inlined$dyLazy$4(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassLivesdkModuleRoomService(), "setCurrentRoom", Classes.INSTANCE.getClassLivesdkapiDependModelLiveRoom());
