...
import com.xp.wx.spellbook.douyin.mirror.com.ss.ugc.live.sdk.message.data.Classes;
...
public final class Methods$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassChatroomPresenterAz(), "onMessage", Classes.INSTANCE.getClassLiveSdkMessageDataIMessage());
