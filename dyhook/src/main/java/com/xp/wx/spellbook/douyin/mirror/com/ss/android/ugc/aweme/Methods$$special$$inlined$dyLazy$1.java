...
public final class Methods$$special$$inlined$dyLazy$1 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        Method method = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassIAccountUserService(), Classes.INSTANCE.getClassProfileModelUser(), new Class[0]));
        if (method != null) {
