...
public final class Fields$$special$$inlined$dyLazy$8 extends Lambda implements Function0<Field> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Fields$$special$$inlined$dyLazy$8(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Class<?> classLivesdkMessageModelBm = Classes.INSTANCE.getClassLivesdkMessageModelBm();
            ...
            Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classLivesdkMessageModelBm, name));
            if (field != null) {
