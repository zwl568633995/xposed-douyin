...
public final class Methods$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method method = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassProfilePresenterK(), C.INSTANCE.getBoolean(), Classes.INSTANCE.getClassProfilePresenterJ()));
            if (method != null) {
                return method;
            }
