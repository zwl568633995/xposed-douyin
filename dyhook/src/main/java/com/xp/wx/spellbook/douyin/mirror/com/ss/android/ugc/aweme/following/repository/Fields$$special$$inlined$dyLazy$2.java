...
public final class Fields$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Field> {
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Class<?> classFollowRelationApi = Classes.INSTANCE.getClassFollowRelationApi();
            String name = Classes.INSTANCE.getClassFollowRelationApi_a().getName();
            Intrinsics.checkExpressionValueIsNotNull(name, "ClassFollowRelationApi_a.name");
            Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classFollowRelationApi, name));
            if (field != null) {
                return field;
            }
