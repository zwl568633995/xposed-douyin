...
import com.xp.wx.spellbook.douyin.mirror.com.ss.android.ugc.aweme.search.model.Classes;
...
public final class Fields$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Field> {
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Class<?> classDiscoverMixfeedS = Classes.INSTANCE.getClassDiscoverMixfeedS();
            String name = Classes.INSTANCE.getClassSearchModelJ().getName();
            Intrinsics.checkExpressionValueIsNotNull(name, "ClassSearchModelJ.name");
            Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classDiscoverMixfeedS, name));
            if (field != null) {
