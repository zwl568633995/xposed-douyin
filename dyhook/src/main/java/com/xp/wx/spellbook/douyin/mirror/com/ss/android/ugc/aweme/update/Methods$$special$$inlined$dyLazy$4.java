...
public final class Methods$$special$$inlined$dyLazy$4 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method method = null;
            Method method2 = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassUpdateUpdateHelper(), (Class<?>) null, C.INSTANCE.getContext(), C.INSTANCE.getBoolean()));
            if (method2 != null) {
