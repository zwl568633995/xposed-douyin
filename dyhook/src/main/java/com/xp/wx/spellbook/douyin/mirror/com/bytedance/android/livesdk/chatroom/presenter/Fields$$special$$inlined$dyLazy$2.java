...
import com.xp.wx.spellbook.douyin.mirror.com.bytedance.android.livesdkapi.depend.model.live.Classes;
...
public final class Fields$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Field> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Fields$$special$$inlined$dyLazy$2(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Class<?> classChatroomPresenterAz = Classes.INSTANCE.getClassChatroomPresenterAz();
            String name = Classes.INSTANCE.getClassLivesdkapiDependModelLiveRoom().getName();
            Intrinsics.checkExpressionValueIsNotNull(name, "ClassLivesdkapiDependModelLiveRoom.name");
            Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classChatroomPresenterAz, name));
            if (field != null) {
