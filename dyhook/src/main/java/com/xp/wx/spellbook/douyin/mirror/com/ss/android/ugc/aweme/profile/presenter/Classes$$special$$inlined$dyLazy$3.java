...
public final class Classes$$special$$inlined$dyLazy$3 extends Lambda implements Function0<Class<? extends Object>> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Classes$$special$$inlined$dyLazy$3(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Class<? extends Object> invoke() {
        ...
        Class<?> firstOrNull = ReflectionUtil.findClassesFromPackage$default(dyLoader, dyClasses, DyGlobal.INSTANCE.getDyPackageName() + '.' + Classes.INSTANCE.getChildPackage(), 0, 8, (Object) null).filterByMethod((Class<?>) C.INSTANCE.getBoolean(), (Class<?>[]) new Class[]{Classes.INSTANCE.getClassProfilePresenterJ()}).filterByMethod("onSuccess", (Class<?>[]) new Class[0]).filterByMethod("onFailed", (Class<?>[]) new Class[]{Exception.class}).firstOrNull();
        if (firstOrNull != null) {
            return firstOrNull;
        }
