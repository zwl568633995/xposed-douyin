...
public final class Fields$$special$$inlined$dyLazy$10 extends Lambda implements Function0<Field> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Fields$$special$$inlined$dyLazy$10(String str) {
        super(0);
        this.$name = str;
    }
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Class<?> classLivesdkMessageModelZ = Classes.INSTANCE.getClassLivesdkMessageModelZ();
            ...
            Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classLivesdkMessageModelZ, name));
            if (field != null) {
