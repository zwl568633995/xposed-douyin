...
import com.xp.wx.spellbook.douyin.mirror.com.ss.android.ugc.aweme.Classes;
...
public final class Methods$$special$$inlined$dyLazy$1 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        Method method = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassAccountE(), Classes.INSTANCE.getClassIAccountUserService(), new Class[0]));
        if (method != null) {
