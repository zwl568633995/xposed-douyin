...
public final class Methods$$special$$inlined$dyLazy$5 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassUpdateUpdateHelper(), "C", new Class[0]);
        if (findMethodExactIfExists != null) {
            findMethodExactIfExists.setAccessible(true);
        } else {
            findMethodExactIfExists = null;
        }
        if (findMethodExactIfExists != null) {
