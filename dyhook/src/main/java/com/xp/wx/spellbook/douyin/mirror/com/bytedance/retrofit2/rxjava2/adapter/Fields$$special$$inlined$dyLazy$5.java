...
public final class Fields$$special$$inlined$dyLazy$5 extends Lambda implements Function0<Field> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Fields$$special$$inlined$dyLazy$5(String str) {
        super(0);
        this.$name = str;
    }

    public final Field invoke() {
        Class<?> classRxjava2AdapterC = Classes.INSTANCE.getClassRxjava2AdapterC();
        String name = Classes.INSTANCE.getClassCall().getName();
        Intrinsics.checkExpressionValueIsNotNull(name, "ClassCall.name");
        Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classRxjava2AdapterC, name));
        if (field != null) {
