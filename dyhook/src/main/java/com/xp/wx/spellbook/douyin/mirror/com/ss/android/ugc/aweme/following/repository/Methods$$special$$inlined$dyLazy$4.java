...
public final class Methods$$special$$inlined$dyLazy$4 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method method = (Method) CollectionsKt.firstOrNull(ReflectionUtil.findMethodsByExactParameters(Classes.INSTANCE.getClassFollowRelationApi_a(), Classes.INSTANCE.getClassFollowRelationApi(), new Class[0]));
            if (method != null) {
                return method;
            }
