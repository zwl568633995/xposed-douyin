...
public final class Classes$$special$$inlined$dyLazy$1 extends Lambda implements Function0<Class<? extends Object>> {
    ...
    public final Class<? extends Object> invoke() {
        ...
        Class<?> firstOrNull = ReflectionUtil.findClassesFromPackage$default(dyLoader, dyClasses, DyGlobal.INSTANCE.getDyPackageName() + '.' + Classes.INSTANCE.getChildPackage(), 0, 8, (Object) null).filterByMethod((Class<?>) null, (Class<?>[]) new Class[]{C.INSTANCE.getString(), C.INSTANCE.getInt(), C.INSTANCE.getInt(), C.INSTANCE.getString()}).filterByMethod(C.INSTANCE.getList(), "getAwemeList", new Class[0]).filterByMethod(C.INSTANCE.getBoolean(), "isHasMore", new Class[0]).firstOrNull();
        if (firstOrNull != null) {
            return firstOrNull;
        }
