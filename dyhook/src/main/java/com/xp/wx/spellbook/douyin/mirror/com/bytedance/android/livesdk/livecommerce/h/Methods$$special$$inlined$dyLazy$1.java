...
public final class Methods$$special$$inlined$dyLazy$1 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassLivesdkLivecommerceHB(), "a", C.INSTANCE.getString(), C.INSTANCE.getString());
