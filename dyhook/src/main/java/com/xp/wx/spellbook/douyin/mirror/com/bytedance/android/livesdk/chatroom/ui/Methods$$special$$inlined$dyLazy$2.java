...
public final class Methods$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Method> {
    ...
    public final Method invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Method findMethodExactIfExists = ReflectionUtil.findMethodExactIfExists(Classes.INSTANCE.getClassLivesdkChatroomUiCh(), "a", Classes.INSTANCE.getClassLivesdkapiDependModelLiveRoom());
