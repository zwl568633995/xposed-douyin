...
public final class Fields$$special$$inlined$dyLazy$2 extends Lambda implements Function0<Field> {
    ...
    public final Field invoke() {
        if (DyGlobal.INSTANCE.getDyVersion() == null) {
            ...
            Class<?> classAppContextManager = Classes.INSTANCE.getClassAppContextManager();
            String name = Classes.INSTANCE.getClassAppContextManager().getName();
            Intrinsics.checkExpressionValueIsNotNull(name, "ClassAppContextManager.name");
            Field field = (Field) CollectionsKt.firstOrNull(ReflectionUtil.findFieldsWithType(classAppContextManager, name));
            if (field != null) {
